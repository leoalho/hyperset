  ...
  boardSets() {
    ...
    for (let i = 0; i < 7; i++) {
      for (let j = i + 1; j < 8; j++) {
        for (let k = j + 1; k < 9; k++) {
          var card1 =
            this.board[(player.position[0] + this.locations[i][0] + 9) % 9][
              (player.position[1] + this.locations[i][1] + 9) % 9
            ].shape;
          var card2 =
            this.board[(player.position[0] + this.locations[j][0] + 9) % 9][
              (player.position[1] + this.locations[j][1] + 9) % 9
            ].shape;
          var card3 =
            this.board[(player.position[0] + this.locations[k][0] + 9) % 9][
              (player.position[1] + this.locations[k][1] + 9) % 9
            ].shape;
